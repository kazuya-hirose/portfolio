...
> **注意：経済学的な意味**
>
> これは「リスクを嫌う」投資家の姿そのもの。次の節で，これが効用関数の**凹さ**から生じることを図で確認する。

---

# 1.3.1　なぜ確実な方が好まれるのか：凹関数の幾何学
...
- 期待効用理論そのものが破れる系統的な現象（後述のvNM公理の破れなど）も知られている
...
# 1.4.1　確実等価額（certainty equivalent）
