...
APTはファクターが何であるかを**特定しない**。実際に使うには具体的に選ぶ必要がある。

<div class="box ex">
<div class="box-title">Chen–Roll–Ross (1986)：マクロファクター</div>

工業生産（景気）・予想外インフレ・信用スプレッド・金利の期間構造などを使用。
...
景気敏感株ほど高い期待リターンを要求され，インフレの保険になる資産は低い期待リターンで保有される。
